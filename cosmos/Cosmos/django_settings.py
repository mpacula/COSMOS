...
MEDIA_ROOT = os.path.join(home_path,'cosmos/media/')
...
STATIC_ROOT = os.path.join(home_path,'cosmos/static/')
...
STATICFILES_DIRS = (
    os.path.join(home_path,'cosmos/Cosmos/static/'),
...
TEMPLATE_DIRS = (
    os.path.join(home_path,'cosmos/templates'),
