...
urlpatterns = patterns('',
    ...
    url(r'JobManager/JobAttempt/(\d+)/$', 'cosmos.JobManager.views.jobAttempt',name='jobAttempt_view'),
#    url(r'JobManager/JobAttempt/(\d+)/output/(.+)$', 'JobManager.views.jobAttempt_output',name='jobAttempt_output'),
    ...
    url(r'Workflow/TaskFile/(\d+)/profile_output/$', 'cosmos.JobManager.views.jobAttempt_profile_output',name='jobAttempt_profile_output'),
    ...
    url(r'Workflow/Stage/(\d+)/$', 'cosmos.Workflow.views.stage_view',name='stage_view'),
    url(r'Workflow/Task/(\d+)/$', 'cosmos.Workflow.views.task_view',name='task_view'),
