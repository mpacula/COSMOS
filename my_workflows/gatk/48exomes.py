...
#B_merge1 = WF.add_batch("BWA Merge Bams by Sample",hard_reset=False)
#for tags,sample_sampe_nodes in B_bwa_sampe.nodes_by('sample'):
#    sample_name = tags['sample']
#    sample_sams = [ n.output_paths['sam'] for n in sample_sampe_nodes ]
